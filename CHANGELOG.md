...
- **CI benchmark delta gate**: added `evalCiGateEnabled`, `openclaw engram benchmark-ci-gate --base <dir> --candidate <dir>`, `scripts/eval-ci-gate.ts`, and an optional `eval-benchmark-gate` GitHub Actions workflow for base-vs-candidate eval-store comparison.
